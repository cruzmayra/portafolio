const data = [
  {
    github: 'https://github.com/cruzmayra/',
    linkedin: 'https://www.linkedin.com/in/cruz-mayra'
  },
  [
    {
      id:'/mitrabajo/venus-ecommerce',
      name: 'Venus e-commerce',
      image: ['assets/images/venus-desktop-01.jpg', 'assets/images/venus-desktop-02.jpg'],
      description: 'E-commerce dirigo a mujeres jóvenes que disfrutan de un estilo en tendencia así como de las prendas sencillas y cómodas. <br>Proyecto colaborativo que aprovecha el uso de la técnica SPA para proveer una interfaz sencilla e intuitiva, permite al usuario saber siempre en que sección se encuentra gracias al uso del routing. Aprovecha el uso de API para ofrecer una extensa variedad de productos (Etsy) y un método de pago sencillo (PayPal).',
      type: 'E-commerce',
    ...
    {
      id:'/mitrabajo/pokedex',
      name: 'Pokédex',
      image: ['assets/images/pokedex-desktop-01.jpg', 'assets/images/pokedex-desktop-02.jpg'],
      description: 'Aplicación que emula la enciclopedia virtual que los entrenadores llevan consigo en la serie, para consultar las fichas de las diversas especies Pokémon.<br>Proyecto individual que hace uso de una GrahpQL API para realizar una sola petición por medio de jQuery. Aprovecha el manejo del DOM para crear de manera dinámina los modales con la información particular de cada pokémon.',
    ...
    },
    {
      id: '/labcar',
      name: 'LabCar',
      image: ['assets/images/lc-desktop-01.jpg', 'assets/images/lc-mobile-01.jpg'],
